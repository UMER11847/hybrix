...
const industries = [
  { icon: Stethoscope, title: 'Clinics & Doctors', problem: "Patients call for appointments, test results, and emergencies at all hours. Reception staff can't keep up.", solution: 'AI answers every call, books appointments, sends reminders, and escalates urgent cases to medical staff instantly.', color: 'text-black', bg: 'bg-[rgb(91_225_176_/_54%)]', tag: 'Healthcare' },
  { icon: Home, title: 'Real Estate Agencies', problem: 'Leads call at all hours asking about listings. Missing a single call can mean losing a million-dollar deal.', solution: 'AI qualifies every inquiry, schedules property viewings, and immediately alerts agents about serious buyers.', color: 'text-black', bg: 'bg-[rgb(91_225_176_/_54%)]', tag: 'Real Estate' },
  { icon: Scissors, title: 'Salons & Spas', problem: "Stylists are with clients all day and can't answer booking calls. No-shows cost the business daily.", solution: 'AI handles all booking calls, sends reminders to reduce no-shows, and manages cancellations automatically.', color: 'text-black', bg: 'bg-[rgb(91_225_176_/_54%)]', tag: 'Beauty' },
  { icon: UtensilsCrossed, title: 'Restaurants', problem: 'Reservation calls come in during the busiest kitchen hours. Staff are too overwhelmed to answer properly.', solution: 'AI takes reservations, answers menu questions, handles delivery inquiries, and manages waitlists hands-free.', color: 'text-black', bg: 'bg-[rgb(91_225_176_/_54%)]', tag: 'Hospitality' },
  { icon: Car, title: 'Car Dealerships', problem: 'Customers call to ask about inventory, pricing, and test drives. Sales teams miss high-intent buyers daily.', solution: 'AI pre-qualifies buyers, schedules test drives, and routes serious customers straight to your top salespeople.', color: 'text-black', bg: 'bg-[rgb(91_225_176_/_54%)]', tag: 'Automotive' },
  { icon: Scale, title: 'Law Firms', problem: 'Potential clients need immediate responses. Missing their call means they call the next firm on their list.', solution: 'AI intakes new cases 24/7, gathers initial case details, qualifies leads, and schedules consultations instantly.', color: 'text-black', bg: 'bg-[rgb(91_225_176_/_54%)]', tag: 'Legal' },
]
