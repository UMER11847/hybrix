...
export default function Benefits() {
  ...
  return (
    <SectionZone zone="benefits" className="section-padding overflow-hidden">
      <div ref={sectionRef} className="max-w-[1280px] mx-auto px-6 lg:px-10 relative">
        <div className="flex justify-center mb-6">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-panel-3d border-emerald-500/30">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {benefits.map((b, i) => (
            <Card3D key={i}>
              <div data-animate className="glass-panel-3d metric-tile rounded-3xl p-7 h-full group">
        ...
        <div data-animate className="mt-16 relative overflow-hidden glass-panel-3d rounded-3xl p-10 md:p-14">
          <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/5 to-emerald-700/5" />
          <div className="relative grid md:grid-cols-2 gap-10 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div key={i} className="glass-light rounded-2xl p-5 metric-tile">
